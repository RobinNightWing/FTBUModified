...
public class FTBUtilitiesPermissions
{
	...
	public static final String CHAT_STAFF_PREFIX = "ftbutilities.chat.staff_prefix";
	public static final String CHAT_DONATOR_PREFIX = "ftbutilities.chat.donator_prefix";
	public static final String CHAT_TERTIARY_PREFIX = "ftbutilities.chat.tertiary_prefix";
	public static final String CHAT_RANK_SUFFIX = "ftbutilities.chat.player_suffix";

	// Utilities //
	public static final String HEAL = "ftbutilities.heal";
	public static final String FEED = "ftbutilities.feed";
	public static final String FLY = "ftbutilities.fly";
	public static final String GOD = "ftbutilities.god";
	public static final String MUTE = "ftbutilities.mute";
	public static final String NICKFOR = "ftbutilities.nickfor";
	...
	public static void registerPermissions()
	{
		...
		//New//
		PermissionAPI.registerNode(HEAL, DefaultPermissionLevel.OP, "Allows the player to heal themsleves");
		PermissionAPI.registerNode(FEED, DefaultPermissionLevel.OP, "Allows people to feed themselves via command");
		PermissionAPI.registerNode(FLY, DefaultPermissionLevel.OP, "Allows players the ability to fly. Warning: OP");
		PermissionAPI.registerNode(GOD, DefaultPermissionLevel.OP, "Allows players to become God, and become immune from all damage and twitter hate");
		PermissionAPI.registerNode(MUTE, DefaultPermissionLevel.OP, "Allows players to mute others");
		PermissionAPI.registerNode(NICKFOR, DefaultPermissionLevel.OP, "Allows a player to change another player's nickname");
	...
	public static void registerConfigs(RegisterRankConfigEvent event)
	{
		...
		event.register(CHAT_STAFF_PREFIX, new ConfigString(""), new ConfigString("[&4OP&r]"));
		event.register(CHAT_DONATOR_PREFIX, new ConfigString(""), new ConfigString(""));
		event.register(CHAT_TERTIARY_PREFIX, new ConfigString(""), new ConfigString(""));
		event.register(CHAT_RANK_SUFFIX, new ConfigString(">"), new ConfigString(">"));
