...
public class FTBUtilitiesPlayerData extends PlayerData
{
	...
	public ITextComponent getNameForChat(EntityPlayerMP playerMP)
	{
		...
		String unparsedDonator = player.getRankConfig(FTBUtilitiesPermissions.CHAT_DONATOR_PREFIX).getString();
		String unparsedStaff = player.getRankConfig(FTBUtilitiesPermissions.CHAT_STAFF_PREFIX).getString();
		String unparsedTertiary = player.getRankConfig(FTBUtilitiesPermissions.CHAT_TERTIARY_PREFIX).getString();

		ITextComponent donatorPrefix = TextComponentParser.parse(unparsedDonator, null);
		ITextComponent staffPrefix = TextComponentParser.parse(unparsedStaff, null);
		ITextComponent tertiaryPrefix = TextComponentParser.parse(unparsedTertiary, null);

		cachedNameForChat = new TextComponentString("").appendSibling(tertiaryPrefix).appendSibling(donatorPrefix).appendSibling(staffPrefix).appendSibling(cachedNameForChat);
