...
public class CmdHome extends CmdBase
{
	...
	{
		EntityPlayerMP playerWarn = getCommandSenderAsPlayer(sender);

		playerWarn.sendMessage(new TextComponentString("\u00a7o Please make sure you use /sethome in all your current FTBU home locations before November 23rd. 2020"));
		if (args0.length == 0)
		{
